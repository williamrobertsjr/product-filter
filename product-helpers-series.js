...
//     let content = value[val].innerText;
//     let regex = /\([^)]*\)/i;
//     // console.log(typeof value[val].innerHTML);
//     // if(typeof value[val].innerHTML == 'string') {
//     //     console.log(value[val].innerHTML);
//     // }
    
//     if(content) {
//         if(content.includes("(")) {
            
//            let newString = content.replace(regex, ' ')
//             value[val].innerText=newString
//         }
//     }
